...
describe('types', function () {
	...
	it('should be sound for double precision floats', function () {
		check(coders.doubleCoder, 0)
		check(coders.doubleCoder, 3.14)
		check(coders.doubleCoder, -Math.E)
		check(coders.doubleCoder, Infinity)
		check(coders.doubleCoder, -Infinity)
		check(coders.doubleCoder, 1 / Infinity)
		check(coders.doubleCoder, -1 / Infinity)
		check(coders.doubleCoder, NaN)
	})

	it('should be sound for single precision floats', function () {
		check(coders.floatCoder, 0)
		check(coders.floatCoder, 0.5)
		check(coders.floatCoder, 1)
		check(coders.floatCoder, Infinity)
		check(coders.floatCoder, -Infinity)
		check(coders.floatCoder, 1 / Infinity)
		check(coders.floatCoder, -1 / Infinity)
		check(coders.floatCoder, NaN)
	})
